...
class WhenTab(ttk.Frame):
    ...
    def run_pdf_transformer(self):
        # 1. SETUP PATHS
        java_exe = r"C:\PROGRA~1\Java\jre1.8.0_471\bin\java.exe"
        working_dir = r"C:\ALWB_Additional_Resources\ages-alwb-transformer-old\net.ages.liturgical.workbench.transformer"
        templates_base = r"C:\git\ages-alwb-templates\net.ages.liturgical.workbench.templates\src-gen\website"
        main_class = "net.ages.liturgical.workbench.transformer.AlwbTransformer"
        
        # 2. THE CLASSPATH
        full_classpath = (
            r"C:\PROGRA~1\Java\jre1.8.0_471\jre\lib\rt.jar;"
            r"C:\PROGRA~1\Java\jre1.8.0_471\jre\lib\jsse.jar;"
            f"{working_dir}\\bin;"
            f"{working_dir}\\lib\\jars\\*;"
            f"{working_dir}\\lib\\fop-1.1\\build\\fop.jar;"
            f"{working_dir}\\lib\\fop-1.1\\lib\\*"
        )
...
class ALWBWorkflowManager:
    ...
    def run_script(self, script_path, arg=None):
        def worker():
            ...
            template_base = Path(
                r"C:\git\ages-alwb-templates\net.ages.liturgical.workbench.templates\a-templates\Dated-Services")
